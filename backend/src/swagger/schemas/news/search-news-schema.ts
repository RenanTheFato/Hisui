...
export const searchNewsSchema = {
  ...
  response: {
    200: z.object({
      ...
      news: z.array(
        z.object({
          id: z.string().describe("Unique ID of the news item."),
          title: z.string().describe("News title."),
          author: z.string().describe("Author of the news."),
          publisher_name: z.string().describe("Publisher name."),
          publisher_url: z.string().describe("Publisher URL."),
          published_at: z.date().describe("Publication date."),
          article_url: z.string().describe("URL of the full article."),
          tickers: z.array(z.string()).describe("List of related stock tickers."),
          amp_url: z.string().nullable().describe("AMP version URL of the article."),
          image_url: z.string().describe("Image URL for the news."),
          description: z.string().describe("Main content or excerpt of the news."),
          insights: z.any().describe("Additional insights data."),
          created_at: z.date().describe("Creation date in the database."),
          updated_at: z.date().describe("Last update date in the database."),
        })
